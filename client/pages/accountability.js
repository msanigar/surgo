        ...
        <div className='advice-container'>
            ...
            <div className='next red-bg book-font'>
              <div className='next-container'>
                ...
                <div className='next-text'>
                  ...
                  <hr></hr>
                  <h4>
                    We give players the tools and knowledge to take control.
                  </h4>
          ...
          <div className='middle book-font'>
            ...
            <span>
              ...
              <p>
                Our holistic philosophy helps players find their own way to
                balance sleep, practice, eating and exercise.{" "}
              </p>
            </span>
            <span>
              <h3>Healthy body</h3>
              <p>
                Having accountability allows players to learn what works for
                them, allowing them to maximize their game time without
                compromising their bodies.
              </p>
            </span>
            <span>
              <h3>Keep record</h3>
              <p>
                Players make it a habit to keep track of their dietary intake ,
                exercise and active schedule so they never feel like they are
            ...
            <span>
              <h3>SoS Meetings</h3>
              <p>
                When things take an unexpected turn - our SoS meetings will help
                players compartmentalise problems into easy to tackle chunks -
