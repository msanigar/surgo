        ...
        <div className="advice-container">
          ...
          <div className="middle book-font">
            ...
            <span>
              <h3>Happy players</h3>
              <p>
                Bad habits, don't just stop you being good, they stop you
                feeling good. By rebuilding new habits, players feel more
                confident in their ability to correct mistakes.
              </p>
            </span>
            <span>
              <h3>Better problem solvers</h3>
              <p>
                Players become better problem solves - once they know how to
                actively fix habits outside of the game. They learn to apply
                this knowledge inside the game.
              </p>
            </span>
            <span>
              <h3>Better communicators</h3>
              <p>
                Players are able to comfortably navigate the communication &
                cultural barriers that once effected their performance.
              </p>
            </span>
            <span>
              <h3>Precision focus</h3>
              <p>
                Players become more focused allowing them to retain more
